...
//                bc.TheBoard.add(b, i, j);
//                GridPane.setMargin(b, new Insets(5, 5, 5, 5));
//                GridPane.setHalignment(b, HPos.CENTER);
//                GridPane.setValignment(b, VPos.CENTER);
//            }
//        }
//        for (int i = 0; i < bc.TheBoard.getChildren().size(); i++) {
//            ((ButtonBase) bc.TheBoard.getChildren().get(i)).setOnMouseClicked(new EventHandler<MouseEvent>() {
//                @Override
...
//                        game.toggleFlag(x, y);
//                    for (Node child : bc.TheBoard.getChildren()) {
